...
const storyTypesData = [
  {
    ...
    iconUrl: 'https://storage.googleapis.com/pictotale-assets/icons/adventure.svg',
    coverImageUrl: 'https://storage.googleapis.com/pictotale-assets/covers/adventure.jpg',
    characteristics: [
      'brave heroes',
      'exciting quests',
      'mysterious places',
  ...
  },
  {
    ...
    iconUrl: 'https://storage.googleapis.com/pictotale-assets/icons/fantasy.svg',
    coverImageUrl: 'https://storage.googleapis.com/pictotale-assets/covers/fantasy.jpg',
    characteristics: [
      'magical creatures',
      'enchanted forests',
      'fairy tale elements',
  ...
  },
  {
    ...
    iconUrl: 'https://storage.googleapis.com/pictotale-assets/icons/friendship.svg',
    coverImageUrl: 'https://storage.googleapis.com/pictotale-assets/covers/friendship.jpg',
    characteristics: [
      'making new friends',
      'helping others',
      'sharing and caring',
  ...
  },
  {
    ...
    iconUrl: 'https://storage.googleapis.com/pictotale-assets/icons/educational.svg',
    coverImageUrl: 'https://storage.googleapis.com/pictotale-assets/covers/educational.jpg',
    characteristics: [
      'learning new things',
      'science experiments',
      'nature exploration',
  ...
  },
  {
    ...
    iconUrl: 'https://storage.googleapis.com/pictotale-assets/icons/mystery.svg',
    coverImageUrl: 'https://storage.googleapis.com/pictotale-assets/covers/mystery.jpg',
    characteristics: [
      'solving puzzles',
      'finding clues',
      'detective work',
  ...
  },
  {
    ...
    iconUrl: 'https://storage.googleapis.com/pictotale-assets/icons/animal.svg',
    coverImageUrl: 'https://storage.googleapis.com/pictotale-assets/covers/animal.jpg',
    characteristics: [
      'talking animals',
      'pet adventures',
  ...
  },
  {
    ...
    iconUrl: 'https://storage.googleapis.com/pictotale-assets/icons/superhero.svg',
    coverImageUrl: 'https://storage.googleapis.com/pictotale-assets/covers/superhero.jpg',
    characteristics: [
      'special powers',
      'helping others',
      'saving the day',
  ...
  },
  {
    ...
    iconUrl: 'https://storage.googleapis.com/pictotale-assets/icons/family.svg',
    coverImageUrl: 'https://storage.googleapis.com/pictotale-assets/covers/family.jpg',
    characteristics: [
      'family traditions',
      'growing up',
      'home life',
...
const dailyChallengesData = [
  {
    ...
    challengeImageUrl: 'https://storage.googleapis.com/pictotale-assets/challenges/adventure.jpg',
    startDate: new Date(),
  ...
  },
  {
    ...
    challengeImageUrl: 'https://storage.googleapis.com/pictotale-assets/challenges/friendship.jpg',
    startDate: new Date(),
    endDate: new Date(Date.now() + 7 * 24 * 60 * 60 * 1000),
  ...
  },
  {
    ...
    challengeImageUrl: 'https://storage.googleapis.com/pictotale-assets/challenges/nature.jpg',
    startDate: new Date(),
    endDate: new Date(Date.now() + 7 * 24 * 60 * 60 * 1000),
